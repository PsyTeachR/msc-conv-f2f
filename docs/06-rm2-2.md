...
<li>Matched pairs design means different people in different conditions but you have matched participants across the conditions (e.g. matched on age, IQ, Social Economic Status, etc.)</li>
...
* Enter the mean estimates and t-test results (means and t-value to 2 decimal places, p-value to 3 decimal places):
    ...
    + Mean `estimate` = <input class='solveme nospaces' size='-.07' data-answer='["-0.07"]'/>  
